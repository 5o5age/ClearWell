<x-layouts.app title="Jauns audio">
    <div class="max-w-2xl mx-auto px-5 py-16">
        <h1 class="brand-font text-3xl font-medium">Publicēt audio</h1>
        ...
        <form method="POST" action="{{ route('admin.audios.store') }}" enctype="multipart/form-data" class="mt-8 space-y-5">
            @csrf
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                    class="textarea textarea-bordered w-full rounded-xl">{{ old('description') }}</textarea>
            </div>

            <div>
                <label class="label"><span class="label-text">Audio fails (mp3, wav, ogg, m4a — līdz 50 MB)</span></label>
