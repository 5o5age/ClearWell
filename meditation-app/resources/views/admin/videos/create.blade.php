<x-layouts.app title="Jauns video">
    <div class="max-w-2xl mx-auto px-5 py-16">
        <h1 class="brand-font text-3xl font-medium">Publicēt video</h1>
        ...
        <form method="POST" action="{{ route('admin.videos.store') }}" enctype="multipart/form-data" class="mt-8 space-y-5">
            @csrf
