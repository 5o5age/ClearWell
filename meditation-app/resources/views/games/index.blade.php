<x-layouts.app title="Spēles">
    ...
    <section class="max-w-5xl mx-auto px-5 py-16">
        ...
        <div class="mb-12">
            <p class="text-xs font-semibold uppercase tracking-widest text-primary/60 mb-3">Spēlē maigi</p>
            <h1 class="brand-font text-4xl sm:text-5xl font-medium leading-tight tracking-tight">Spēles</h1>
            <p class="mt-4 text-base text-base-content/50 max-w-xl leading-relaxed">
                Apzināti, viegli vingrinājumi, lai trenētu koncentrēšanos, mieru un klātbūtni maigā mijiedarbībā.
            </p>
        </div>
