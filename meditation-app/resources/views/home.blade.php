<x-layouts.app title="Welcome">
    ...
    <section class="relative overflow-hidden min-h-[88vh] flex items-center">
        ...
        <div class="absolute inset-0" aria-hidden="true">
            <img src="{{ asset('images/hero_dark_forest.jpg') }}"
                 data-hero-img
                 alt=""
        ...
        <div class="relative w-full max-w-7xl mx-auto px-5 pt-28 pb-24 flex flex-col items-center text-center">
            ...
            <h1 class="brand-font text-5xl sm:text-6xl md:text-7xl font-medium leading-[1.08] tracking-tight max-w-3xl text-white drop-shadow-md">
                Find calm<br>
                <span class="italic text-white/70">within the noise.</span>
            </h1>

            {{-- Sub-headline --}}
            <p class="mt-6 text-base sm:text-lg text-white/55 max-w-xl leading-relaxed font-light drop-shadow-sm">
                Clearwell brings you guided audio, calming video, mindful reading,
                and gentle games — a complete space to breathe, reset, and return to yourself.
            </p>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <a href="{{ route('audio.index') }}"
               class="group relative rounded-3xl border border-base-200/80 bg-base-100 p-7 hover:shadow-lg hover:shadow-base-300/40 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden">
                ...
                <p class="text-sm text-base-content/45 leading-relaxed">
                    Nature sounds, breathing guides, and deep relaxation tracks to quiet the mind.
                </p>
            ...
            <a href="{{ route('video.index') }}"
               class="group relative rounded-3xl border border-base-200/80 bg-base-100 p-7 hover:shadow-lg hover:shadow-base-300/40 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden">
                ...
                <p class="text-sm text-base-content/45 leading-relaxed">
                    Gentle visuals, guided movement, and immersive sessions to anchor you in the present.
                </p>
            ...
            <a href="{{ route('pages.index') }}"
               class="group relative rounded-3xl border border-base-200/80 bg-base-100 p-7 hover:shadow-lg hover:shadow-base-300/40 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 class="brand-font text-xl font-medium mb-2">Pages</h3>
                <p class="text-sm text-base-content/45 leading-relaxed">
                    Thoughtful articles, practices, and guided reading to deepen your mindful journey.
                </p>
            ...
            <a href="{{ route('games.index') }}"
               class="group relative rounded-3xl border border-base-200/80 bg-base-100 p-7 hover:shadow-lg hover:shadow-base-300/40 hover:-translate-y-0.5 transition-all duration-300 overflow-hidden">
                ...
                <h3 class="brand-font text-xl font-medium mb-2">Games</h3>
                <p class="text-sm text-base-content/45 leading-relaxed">
                    Playful, low-pressure exercises that train focus, calm, and presence through gentle interaction.
                </p>
    ...
    <section class="border-y border-base-200/50 bg-base-200/20">
        <div class="max-w-3xl mx-auto px-5 py-20 text-center">
            ...
            <blockquote class="brand-font text-2xl sm:text-3xl font-medium leading-snug text-base-content/75 italic">
                "You don't have to control your thoughts.<br class="hidden sm:block">
    ...
    <section class="max-w-7xl mx-auto px-5 py-24">
        ...
        <div class="text-center mb-14">
            <p class="text-xs font-semibold uppercase tracking-widest text-primary/60 mb-3">Simple by design</p>
            <h2 class="brand-font text-3xl sm:text-4xl font-medium text-base-content">How Clearwell works</h2>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 relative">

            {{-- Connector line (desktop only) --}}
            <div class="hidden md:block absolute top-8 left-[calc(16.66%+1.5rem)] right-[calc(16.66%+1.5rem)] h-px bg-base-200/80 pointer-events-none"></div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="font-semibold text-base-content/80 mb-2">Choose your practice</h3>
                <p class="text-sm text-base-content/45 leading-relaxed max-w-xs">
                    Browse audio sessions, videos, reading pages, or mindful games — whatever fits your mood right now.
                </p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="font-semibold text-base-content/80 mb-2">Set aside a moment</h3>
                <p class="text-sm text-base-content/45 leading-relaxed max-w-xs">
                    Even five minutes counts. Close the tab, put down the phone, and give this moment to yourself.
                </p>
            </div>
            ...
            <div class="flex flex-col items-center text-center">
                ...
                <h3 class="font-semibold text-base-content/80 mb-2">Return, refreshed</h3>
                <p class="text-sm text-base-content/45 leading-relaxed max-w-xs">
                    Come back to your day with a steadier breath, a clearer mind, and a little more space inside.
                </p>
            </div>
    ...
    <section class="max-w-7xl mx-auto px-5 pb-24">
        <div class="relative rounded-3xl overflow-hidden border border-primary/15 bg-primary/6 px-8 py-14 text-center">
            ...
            <p class="relative text-xs font-semibold uppercase tracking-widest text-primary/60 mb-4">Free to join</p>
            ...
            <p class="relative text-base text-base-content/50 max-w-md mx-auto mb-8 leading-relaxed">
                Create a free account to save your favourite sessions, track your practice, and build a habit of calm.
            </p>
